        ...
        if (null === $data) {
            ...
            if (strrpos($inner, ",") !== false) {
                ...
                foreach ($data as $key => $value) {
                    ...
                    if ($subClass == "object") {
                        //if the mapped value type is object, they just output the thing directly
                        $deserialized[$key] = $value;
                    } else {
                        //otherwise, deserialize the secondary object
            ...
            if (!in_array($data, $class::getAllowableEnumValues())) {
                ...
                throw new \InvalidArgumentException("Invalid value for enum '$class', ($data) must be one of: '$imploded'");
            }
            return $data;
        } else {
