...
/**
 * HeadlessContentPageVisibility Class Doc Comment
 *
 * @category Class
 * @package  Agility\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HeadlessContentPageVisibility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HeadlessContentPageVisibility';
...
'sitemap' => 'getSitemap'    ];
     ...
     * Sets menu
     *
     * @param bool $menu Indicates if page is visible in the menu.
     *
     * @return $this
     */
     ...
     * Sets sitemap
     *
     * @param bool $sitemap Indicates if the page is visible in the sitemap.
     *
     * @return $this
     */
